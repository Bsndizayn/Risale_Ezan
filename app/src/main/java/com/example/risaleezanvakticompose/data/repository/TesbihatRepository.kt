    ...
    private fun getSabahTesbihat(): TesbihatContent {
        ...
        items.add(
            TesbihatItem(
                ...
                transcription = "Allahümme ecirnâ min külli nâr. Allahümme ecirnâ min fitnetid-dîniyyeti ved-dünyeviyyeh...",
                translation = "Allah'ım! Bizi her türlü ateşten, din ve dünya fitnesinden, ahir zaman fitnesinden, Deccal ve Süfyan fitnesinden koru...",
                count = 1,
                type = TesbihatType.DUA,
                order = 6
            )
...
// 9. Âyetü'l Kürsî
        ...
        items.add(
            TesbihatItem(
                ...
                transcription = "Bismillahir-rahmanir-rahîm. Lâ yestevî as-hâbün-nâri ve as-hâbül-cenneh, as-hâbül-cenneti hümül-fâizûn...",
                translation = "Allah'ın adıyla Rahmân ve Rahîm olan. Cehennem ehli ile cennet ehli eşit değildir. Kurtuluşa erenler cennet ehlidir. Eğer biz bu Kur'an'ı bir dağa indirseydik, onu Allah korkusundan baş eğmiş, parça parça olmuş görürdün...",
                count = 1,
                type = TesbihatType.AYET,
                order = 19
            )
    ...
    private fun getOgleTesbihat(): TesbihatContent {
        ...
        items.add(
            TesbihatItem(
                ...
                translation = "Allah, kendisinden başka ilah olmayandır. O Hayy'dır, Kayyûm'dur...",
                count = 1,
                type = TesbihatType.AYET,
                order = 3
            )
        ...
        items.add(
            TesbihatItem(
                ...
                translation = "Allah'tan başka ilah yoktur. O birdir, ortağı yoktur...",
                count = 1,
                type = TesbihatType.ZIKIR,
                order = 7
            )
        ...
        items.add(
            TesbihatItem(
                ...
                transcription = "Bismillahir-rahmanir-rahîm. Yâ Cemîl yâ Allah, yâ Karîb yâ Allah. Yâ Mücîb yâ Allah, yâ Habîb yâ Allah...",
                translation = "Allah'ın adıyla. Ey Cemîl (güzel) olan Allah! Ey Karîb (yakın) olan Allah! Ey Mücîb (icabet eden) olan Allah!...",
                count = 1,
                type = TesbihatType.DUA,
                order = 10
            )
        ...
        items.add(
            TesbihatItem(
                ...
                transcription = "Bismillahir-rahmanir-rahîm. Lekad sadakallahü rasûlehür-rü'yâ bil-hakk...",
                translation = "Allah'ın adıyla. Allah, Resulüne rüyayı gerçek olarak doğruladı...",
                count = 1,
                type = TesbihatType.AYET,
                order = 11
            )
        ...
        items.add(
            TesbihatItem(
                ...
                translation = "Rahmân ve Rahîm olan Allah'ın adıyla. Hamd, âlemlerin Rabbi Allah'a mahsustur...",
                count = 1,
                type = TesbihatType.SURE,
                order = 12
            )
